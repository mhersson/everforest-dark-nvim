...
function M.load()
    ...
    -- snacks.nvim
    hi("SnacksNormal", { fg = p.fg, bg = p.bg0 })
    hi("SnacksNormalNC", { fg = p.fg, bg = p.bg0 })
    ...
    hi("SnacksNotifierBorderInfo", { fg = p.blue, bg = p.bg0 })
    hi("SnacksNotifierBorderWarn", { fg = p.yellow, bg = p.bg0 })
    hi("SnacksNotifierBorderError", { fg = p.red, bg = p.bg0 })
    hi("SnacksNotifierBorderDebug", { fg = p.grey1, bg = p.bg0 })
    hi("SnacksNotifierBorderTrace", { fg = p.purple, bg = p.bg0 })
    ...
    hi("CopilotAnnotation", { fg = p.grey0, italic = true })

    -- LSP inline completion (Neovim native)
    hi("ComplHint", { fg = p.grey0 })
    hi("ComplHintMore", { fg = p.grey0 })
